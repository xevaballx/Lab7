...
/**
 * Set of methods for Rock Paper Scissor Lizard Spock Class
 * @author Eva Ball
 * @version 1.0
 */
public class RPSLSpock {
    ...
    /**
     * isValidPick Method
     * Validate pick and ignore case, used as h_pick in Main
     * @param pick validated pick becomes h_pick inputted from human in Main
     * @return boolean values validating pick
     */
    ...
    /**
     * generatePick Method
     * Generates and assigns a random choice to pick used in Main as c_pick
     * @return pick which can be: ROCK; PAPER; SCISSORS; LIZARD; SPOCK,
     * randomly assigned by computer and used as c_pick in Main
     */
     ...
     * Determines if computer wins by comparing h_pick and c_pick
     * @param c_pick computer pick
     * @param h_pick human pick
     * @return boolean value indicated if computer has won = true or has not = false
     */
